...
function App() {
  ...
  return (
    <>
      <section className="hero" style={{ minHeight: '6vh', padding: '0.4rem 0.7rem', marginBottom: '0' }}>
        <h1 className="title" style={{ fontSize: 'clamp(32px, 4.5vw, 55px)', margin: '0', gap: '8px' }}>
          <img
